...
module IconSidebar
  class Component < ViewComponent::Base
    ...
    attr_reader :active_item, :items, :controller_name
    ...
    def default_items
      [
        { id: 'organizations', icon: 'building', label: 'Organizations', sidebar_type: 'organizations' },
        { id: 'tasks', icon: 'clipboard-list', label: 'Tasks', sidebar_type: 'tasks' },
        { id: 'users', icon: 'users', label: 'Users', sidebar_type: 'users' },
        { id: 'campaigns', icon: 'megaphone', label: 'Campaigns', sidebar_type: 'campaigns' },
        { id: 'analytics', icon: 'chart-bar', label: 'Analytics', sidebar_type: 'analytics' },
        { id: 'settings', icon: 'cog', label: 'Settings', sidebar_type: 'settings' }
      ]
    end
    ...
    def icon_svg(icon_name)
      ...
      icons[icon_name] || icons['building']
    end
  end
end